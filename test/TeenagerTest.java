...
public class TeenagerTest {
    ...
    void initialization() {
        ...
        t1 = new Teenager(name1, forname1, birthDate1, countryName1);
        t2 = new Teenager(name2, forname2, birthDate2, countryName2, requirements2);
        t3 = new Teenager(name3, forname3, birthDate3, countryName3, requirements3);
        t4 = new Teenager(forname4, forname4, birthDate4, countryName4);
        t5 = new Teenager(name5, forname5, birthDate5, countryName5);
    ...
    void testAddCriterion(){
        Criterion estPasAlergique = new Criterion("no", CriterionName.GUEST_ANIMAL_ALLERGY);
        Teenager t5 = new Teenager(forname2, forname1, birthDate1, countryName1);
        assertTrue(t5.addCriterion(CriterionName.GUEST_ANIMAL_ALLERGY.name(), estPasAlergique));
        assertEquals(t5.getRequirements().size(), 1);
        Teenager t6 = new Teenager(forname2, forname1, birthDate1, countryName1);
