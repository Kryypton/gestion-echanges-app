...
public class Test {
    public static void main(String[] args) {
        ...
        Teenager teenager5 = new Teenager(5, "Eve", "Wilson", "F", LocalDate.of(2005, 4, 30), Country.ALLEMAGNE , requirements1);
        Teenager teenager6 = new Teenager(6, "Frank", "Anderson", "M", LocalDate.of(2005, 7, 25), Country.ESPAGNE,requirements2);
        Teenager teenager7 = new Teenager(7, "Grace", "Taylor", "F", LocalDate.of(2005, 3, 5), Country.FRANCE, requirements3);
        Teenager teenager8 = new Teenager(8, "Henry", "Thomas", "M", LocalDate.of(2005, 9, 1), Country.ITALIE,requirements4); 
